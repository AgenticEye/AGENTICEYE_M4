...
from utils.nlp_utils import top_topics, extract_questions, overall_sentiment_summary
...
# Alias for compatibility with analysis.py
compute_engagement_metrics = lambda source_data: compute_engagement_stats(source_data.get("youtube", {}).get("comments", []) if "youtube" in source_data else [])
